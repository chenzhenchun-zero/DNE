...
#include "MovieSceneDNEVTrack.generated.h"

/**
 * Handles animation of DNEV actors
 */
class UDNEVMeshComponent;

UCLASS(MinimalAPI)
class UMovieSceneDNEVTrack
...
public:
	...
	virtual UMovieSceneSection* AddNewAnimation(FFrameNumber KeyTime, UDNEVMeshComponent* DNEVComp);
